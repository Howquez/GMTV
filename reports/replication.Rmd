...
gaechter <- noPunish10[order(gr_id, per),
           .(treatment = "noPunish10", 
             ...
             endowment = gdp/4,
             share = mean,
             stock = (gdp + ceiling(sum/4*1.5)*4-sum)/4,
             gain = (ceiling(sum/4*1.5)*4-sum)/4,
             bot_active = 0,
             disaster = 0,
             EWE = 0,
...
save(gaechter, file = "../data/processed/gaechter2017.rda")
write.csv(gaechter, file ="../data/processed/gaechter2017.csv")
