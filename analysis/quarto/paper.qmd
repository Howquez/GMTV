...
observed the participants' behavior in voluntary climate actions (VCA). This yielded a setting similar to @GKLS2020's which allows me to analyze how behavior in the abstract game translates into real-world action across samples. The article shows that the dynamic setting _does not_ add any advances with respect to generalizability of results.
