...
`r summary(lm(formula = contributionShare ~ donationShare + student + donationShare*student, data = temp))$coefficients[4,4] %>% round(digits = 2)`). Finally, (d) contributions in the abstract public good game are higher than contributions to the real public good of climate change mitigation.
