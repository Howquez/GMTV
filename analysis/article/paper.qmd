...
This finding is remarkable given the different sample and language, the different software and user interface as well as the online setting during the COVID-19 pandemic. The result suggests that by and large, the sum of these factors did not affect people’s preferences towards cooperation.
...
I gratefully acknowledge support by the German Research Foundation (DFG) under Germany’s Excellence Strategy, cluster EXC 2037 “Climate, Climatic Change, and Society” (project 390683824). I thank Stefan Traub, Alexandrea Swanson, and the participants of the CLICCS B5 group for helpful discussions.
