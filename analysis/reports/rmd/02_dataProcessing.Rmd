...
[This report](https://github.com/Howquez/coopUncertainty/blob/July21Replication/analysis/reports/rmd/02_dataProcessing.Rmd) is the second in a series of reports covering this project. It explains how simulated data is processed and prepared for analyses.
...
# DT <- read.csv(paste("../..", recentCSV, sep = "/"), 
#                stringsAsFactors = FALSE) %>%
#   data.table()

# subset complete cases
# DT <- DT[participant._index_in_pages == 77 & !is.na(dPGG.1.player.contribution)]
```
