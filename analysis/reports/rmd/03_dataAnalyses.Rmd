...
The table above displays summary statistics for the 10th period's ```stock``` a.k.a _Wealth_. The rank sum test yields a p-Value of `r rs1` for the mean wealth during the last period of the game.

The following table shows a simple regression to illustrate differences in the 10th period's wealth between the replication's data and GMTV's data.
...
These information are also plotted over all periods in the following figure.
...
The following figure plots the Gini-coefficient These over all periods.
...
The following table shows a simple regression to illustrate differences in the 10th period's Gini coefficient between the replication's data and GMTV's data.
...
The table above displays summary statistics for the 10th period's ```gini``` .
